...
fcen = 2.0  # center frequency of CW source (wavelength is 1 μm)

tilt_angle = math.radians(45)  # angle of tilted beam
...
sim.run(
    mp.at_every(0.5, mp.output_png(mp.Ez, "-Zc dkbluered")), until=4)
